/*Ovaj program učitava podatke iz datoteke ispit.txt u niz struktura studenti,
zatim sortira niz struktura prema broju bodova od većeg prema manjem, te
ispisuje sadržaj sortiranog niza studenti u datoteku ispit_sortiran.txt.*/
