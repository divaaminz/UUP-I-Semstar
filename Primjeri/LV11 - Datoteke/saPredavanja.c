/* Unesite sljedeći program. Ovaj program određuje broj redova, broj riječi i broj znakova (pri
 čemu se "whitespace" znakovi ne računaju) u tekstualnoj datoteci čije se ime unosi sa tastature.*/
#include <stdio.h>
