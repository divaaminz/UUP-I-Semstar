/*11. Učitati članove niza. Izračunati i ispisati sumu članova niza čiji je indeks djeljiv sa 3.
...
int main(){
    ...
    printf("Ispis sume clanova niza ciji index nije djeljiv sa 3: %d\n", suma );
    ...
    printf("Ispis sume clanova niza djeljivih sa 2 %d \n", suma_p);
    ...
    printf("Ispis sume clanova niza koji nisu djeljivi sa 2 %d \n", suma_n);
    return 0;
}